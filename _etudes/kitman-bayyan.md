...
{% include verset.html ref="Sourate 2 · Al-Baqara · v. 159" ar="إِنَّ ٱلَّذِينَ يَكْتُمُونَ مَآ أَنزَلْنَا مِنَ ٱلْبَيِّنَـٰتِ وَٱلْهُدَىٰ مِنۢ بَعْدِ مَا بَيَّنَّـٰهُ لِلنَّاسِ فِى ٱلْكِتَـٰبِ ۙ أُو۟لَـٰٓئِكَ يَلْعَنُهُمُ ٱللَّهُ وَيَلْعَنُهُمُ ٱللَّـٰعِنُونَ" trl="*Inna lladhīna **yaktumūna** mā anzalnā mina l-**bayyināt** wa-l-**hudā** — min baʿdi mā **bayyannāhu** li-l-nāsi fī l-kitāb — ulāʾika **yalʿanuhum llāhu** wa-**yalʿanuhumu l-lāʿinūn***" trad="Certes, ceux qui **dissimulent** ce que Nous avons fait descendre en fait de ***bayyināt*** et de ***hudā*** — après que Nous l'avons **rendu manifeste** aux gens dans le Livre — voilà ceux qu'**Allaah exclut** et que **les excluseurs excluent**." %}

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 160" ar="إِلَّا ٱلَّذِينَ تَابُوا۟ وَأَصْلَحُوا۟ وَبَيَّنُوا۟ فَأُو۟لَـٰٓئِكَ أَتُوبُ عَلَيْهِمْ ۚ وَأَنَا ٱلتَّوَّابُ ٱلرَّحِيمُ" trl="*Illā lladhīna **tābū** wa-**aṣlaḥū** wa-**bayyinū** — fa-ulāʾika atūbu ʿalayhim — wa-anā **l-tawwāb al-raḥīm***" trad="Sauf ceux qui **retournent** (*tābū*) et **rectifient** (*aṣlaḥū*) et **déclarent** (*bayyinū*) — ceux-là, Je reçois leur retour — Et c'est Moi ***al-tawwāb al-raḥīm***." %}

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 161–162" ar="إِنَّ ٱلَّذِينَ كَفَرُوا۟ وَمَاتُوا۟ وَهُمْ كُفَّارٌ أُو۟لَـٰٓئِكَ عَلَيْهِمْ لَعْنَةُ ٱللَّهِ … خَالِدِينَ فِيهَا لَا يُخَفَّفُ عَنْهُمُ الْعَذَابُ" trl="*Inna lladhīna **kafarū wa-mātū wa-hum kuffār** — ulāʾika ʿalayhim laʿnatu llāh … **khālidīna fīhā** lā yukhaffafu ʿanhum al-ʿadhāb*" trad="Certes, ceux qui **ont recouvert et sont morts en état de kufr** — sur eux pèse la malédiction d'Allaah … **demeurant en elle** pour toujours — le châtiment ne leur sera pas allégé." %}

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 163" ar="وَإِلَـٰهُكُمْ إِلَـٰهٌ وَٰحِدٌ ۖ لَّآ إِلَـٰهَ إِلَّا هُوَ ٱلرَّحْمَـٰنُ ٱلرَّحِيمُ" trl="***Wa-ilāhukum ilāhun wāḥid** — lā ilāha illā huwa — al-Raḥmān al-Raḥīm*" trad="Et votre ***ilāh*** est un ***ilāh* unique** — pas d'***ilāh*** sauf Lui — le ***Raḥmān***, le ***Raḥīm***." %}

---

## III · Lexique fondamental

{% include nl.html racine="ك-ت-م" contenu="**Katama / yaktumu** — Ibn Fāris : *al-aṣl = ikḥfāʾ al-shayʾ wa-sttuhu* — cacher et voiler une chose. Le terme implique une dissimulation **active et volontaire** — non une ignorance, mais un choix de taire ce qu'on sait." %}

{% include nl.html racine="ب-ي-ن" contenu="**Bayyanna / bayyana** — Ibn Fāris : *al-aṣl = al-inakshāf wa-l-wuḍūḥ wa-l-ẓuhūr* — le dévoilement, la clarté, la manifestation. Forme II (intensif) : rendre manifeste, déclarer clairement. ***Al-bayyina*** : la preuve manifeste, ce qui se montre de soi-même. **Antonyme structurel de k-t-m.**" %}

{% include nl.html racine="ل-ع-ن" contenu="**Laʿana / laʿna / al-lāʿinūn** — Ibn Fāris : *al-aṣl = al-ṭard wa-l-ibʿād* — le bannissement et l'éloignement. *La laʿna* n'est pas la colère mais **l'exclusion, le rejet hors d'une sphère**. Être exclu par Allaah : être rejeté de Sa raḥma." %}
...
{% include callout.html type="silence" label="Zone de silence — les lāʿinūn" content="Le texte ne spécifie pas qui sont « les excluseurs ». Le verset 2:161 précisera que la malédiction d'Allaah, des *malāʾika* et de l'ensemble des gens pèse sur ceux qui meurent dans le *kufr* — mais le texte ne fait pas explicitement ce lien avec *al-lāʿinūn* de 2:159. Leur identité reste non-dit." %}

---

## V · Les trois conditions du pardon

{% include callout.html type="dit" label="La progression intérieur → extérieur" content="
...
{% include verset.html ref="Sourate 3 · Āl ʿImrān · v. 187 (extrait)" ar="لَتُبَيِّنُنَّهُ لِلنَّاسِ وَلَا تَكْتُمُونَهُ" trl="***La-tubayyinunnahu li-l-nās** — wa-lā **taktumūnahu***" trad="« Vous le **rendrez certainement manifeste** aux gens — et vous ne le **dissimulerez** pas. »" %}
...
{% include nl.html contenu="***Ilāh*** — Al-Khalīl, Ibn Fāris : ce vers quoi on se tourne en état de dévotion totale, l'objet de l'orientation existentielle suprême. Le terme ne peut être traduit par « divinité » — il est préservé en translittération avec la glose : **objet de dévotion/d'orientation totale**." %}
...
{% include callout.html type="silence" label="Zones de silence" content="
