...
<div class="declaration">
  <span class="declaration__label">Note liminaire</span>
  <p>Cette étude est conduite depuis les trois lexicographes classiques — al-Farāhīdī (<em>Kitāb al-ʿAyn</em>), Ibn Fāris (<em>Maqāyīs al-Lugha</em>), Ibn Manẓūr (<em>Lisān al-ʿArab</em>) — comme références de langue uniquement, sans autorité sur le sens du texte. Elle fusionne deux études antérieures : l'examen historique et coranique de <em>al-Kiswa</em> et l'analyse lexicographique de <em>al-Baraka wa-l-Tabarruk</em>. Cette fusion révèle que la pratique consistant à toucher, embrasser ou prélever un fragment de la Kiswa n'est pas seulement absente du texte coranique — sa structure même est en collision directe avec ce que le texte établit de la baraka.</p>
</div>
...
{% include verset.html ref="Sourate 2 · Al-Baqara · v. 233 — kiswa appliquée aux mères allaitantes" ar="وَعَلَى الْمَوْلُودِ لَهُ رِزْقُهُنَّ وَكِسْوَتُهُنَّ بِالْمَعْرُوفِ" trl="*Wa-ʿalā l-mawlūdi lahu rizquhunna wa-**kiswatuhunna** bi-l-maʿrūf*" trad="À celui à qui l'enfant est attribué incombe leur subsistance et leur **habillement** selon ce qui est connu et convenu." %}

{% include verset.html ref="Sourate 5 · Al-Māʾida · v. 89 — kiswa comme expiation du serment rompu" ar="فَكَفَّارَتُهُ إِطْعَامُ عَشَرَةِ مَسَاكِينَ مِنْ أَوْسَطِ مَا تُطْعِمُونَ أَهْلِيكُمْ أَوْ كِسْوَتُهُمْ" trl="*Fa-kaffāratuhu iṭʿāmu ʿashrati masākīna min awsaṭi mā tuṭʿimūna ahlīkum aw **kiswatuhum***" trad="Son expiation consiste à nourrir dix nécessiteux… ou à les **habiller**." %}

{% include verset.html ref="Sourate 4 · Al-Nisāʾ · v. 5 — kasā appliqué à la pourvoyance vestimentaire" ar="وَلَا تُؤْتُوا السُّفَهَاءَ أَمْوَالَكُمُ … وَارْزُقُوهُمْ فِيهَا وَاكْسُوهُمْ" trl="*Wa-lā tuʾtū s-sufahāʾa amwālakumu … wa-rzuqūhum fīhā **wa-ksūhum***" trad="Ne remettez pas aux personnes inaptes… pourvoyez-les en subsistance et **habillez-les**." %}

{% include verset.html ref="Sourate 23 · Al-Muʾminūn · v. 14 — kasā appliqué métaphoriquement à l'embryologie" ar="فَخَلَقْنَا الْمُضْغَةَ عِظَامًا فَكَسَوْنَا الْعِظَامَ لَحْمًا" trl="*Fa-khalaqnā l-muḍghata ʿiẓāman **fa-kasawnā** l-ʿiẓāma laḥman*" trad="Puis nous avons fait de la masse compacte des os, et nous avons **revêtu** les os de chair." %}

{% include nl.html racine="ك · س · و" contenu="
...
{% include verset.html ref="Sourate 2 · Al-Baqara · v. 125" ar="وَإِذْ جَعَلْنَا الْبَيْتَ مَثَابَةً لِّلنَّاسِ وَأَمْنًا … وَعَهِدْنَا إِلَى إِبْرَاهِيمَ وَإِسْمَاعِيلَ أَن طَهِّرَا بَيْتِيَ لِلطَّائِفِينَ" trl="*Wa-idh jaʿalnā l-bayta **mathābatan li-n-nāsi wa-amnan** … an **ṭahhirā baytiya** li-ṭ-ṭāʾifīna wa-l-ʿākifīna wa-r-rukkaʿi s-sujūd*" trad="Et quand Nous avons fait du Bayt **un lieu de retour répété pour les gens et une sécurité** … qu'ils **maintiennent Ma Maison pure** pour ceux qui en font le tour, ceux qui s'y retirent, ceux qui s'inclinent et se prosternent." %}

{% include verset.html ref="Sourate 3 · Āl ʿImrān · v. 96" ar="إِنَّ أَوَّلَ بَيْتٍ وُضِعَ لِلنَّاسِ لَلَّذِي بِبَكَّةَ مُبَارَكًا وَهُدًى لِّلْعَالَمِينَ" trl="*Inna awwala baytin wuḍiʿa li-n-nāsi la-lladhī bi-Bakkata **mubārakan wa-hudan li-l-ʿālamīn***" trad="Certes, la première Maison établie pour les gens est bien celle qui se trouve à Bakka — **mubārakan et guidance pour les mondes**." %}

{% include verset.html ref="Sourate 22 · Al-Ḥajj · v. 26 — Observation pivot" ar="وَإِذْ بَوَّأْنَا لِإِبْرَاهِيمَ مَكَانَ الْبَيْتِ أَن لَّا تُشْرِكْ بِي شَيْئًا وَطَهِّرْ بَيْتِيَ" trl="*Wa-idh bawwaʾnā li-Ibrāhīma makāna l-bayti an **lā tushrik bī shayʾan** wa-ṭahhir baytiya li-ṭ-ṭāʾifīna*" trad="Et lorsque Nous avons assigné à Ibrāhīm l'emplacement du Bayt : **« N'associe rien à Moi »** et maintiens Ma Maison pure pour ceux qui en font le tour." %}

{% include callout.html type="pivot" label="Observation pivot — S.22:26" content="Le verset même qui établit l'emplacement du Bayt pour Ibrāhīm énonce **immédiatement** l'interdiction absolue de *shirk* à son propos. Ce couplage textuel est central pour la suite de l'étude : le Bayt est posé par le texte coranique comme un lieu où, plus encore qu'ailleurs, le *shirk* est nommément exclu." %}
...
{% include callout.html type="nondit" label="Non-dit absolu sur la kiswa" content="Le Coran est totalement silencieux sur : toute couverture (*kiswa*, *ghishāʾ*, *libās*, *sitr*) appliquée à l'édifice · toute couleur prescrite, recommandée, ou même mentionnée · toute cérémonie périodique de revêtement ou de remplacement de tissu · toute décoration ou ornementation de l'édifice · toute distinction entre un état « habillé » et un état « nu » du Bayt. **Aucune périphrase, aucune métaphore, aucune allusion contextuelle ne suggère que l'édifice soit objet d'un revêtement matériel rituel.**" %}

{% include callout.html type="inf" label="Ce que le silence signifie — et ce qu'il ne signifie pas" content="Le Coran **ne prescrit pas** la couverture de la Kaʿba. Il **ne décrit pas** la couverture comme rite associé au ḥajj. Il **ne reconnaît pas** la couverture comme élément constitutif du caractère *ḥarām* du Bayt. La pratique de la kiswa **ne tire aucune autorité textuelle** du Coran.
...
{% include callout.html type="warn" label="Avertissement épistémologique" content="Ce qui suit ne relève plus du texte coranique mais de l'historiographie arabe et islamique. Ces sources ne sont **pas normatives**, présentent des chaînes de transmission tardives (compilation 150 à 250 ans après les faits qu'elles rapportent), et sont fréquemment surdéterminées par les enjeux politiques et dynastiques de leur époque de rédaction. Elles sont citées ici à titre **documentaire** uniquement." %}
...
{% include nl.html racine="ب · ر · ك" contenu="
...
{% include callout.html type="dit" label="Ce que le verset dit — analyse syntaxique" content="Le verset présente *mubārakan* en **coordination directe avec *hudan li-l-ʿālamīn*** : *mubārakan wa-hudan*. Cette coordination indique que la baraka du Bayt est de la même nature que sa fonction de guidance : **un état fonctionnel reçu d'Allaah, attaché à la fonction de l'édifice pour les gens**." %}

{% include callout.html type="nondit" label="Ce que le verset ne dit pas" content="Il ne dit pas que la **matière physique** de l'édifice est elle-même source de baraka. Il ne dit pas que **ce qui touche** cet édifice acquiert sa baraka. Il ne dit pas que **ce qui le recouvre** participe à son statut. Il ne dit pas que **fragmenter, prélever, conserver** quoi que ce soit qui aurait été en contact avec l'édifice transfère quelque chose." %}

{% include callout.html type="pivot" label="Le piège méthodologique nommé" content="L'objection consiste à **retourner la position morphologique** du Bayt : passer de *mubārak* (récepteur, état reçu d'Allaah) à émetteur (source de baraka captable). Cette opération transforme le Bayt en ce que la langue arabe et l'usage coranique réservent exclusivement à Allaah par la forme *tabāraka*. **C'est précisément l'opération que la structure morphologique de la baraka exclut.**" %}

---

## Partie VIII · Démonstration croisée — Trois invalidités structurelles

{% include callout.html type="contra" label="Invalidité 1 — La Kiswa n'est pas le Bayt" content="Le statut *mubārak* énoncé en 3:96 porte sur **le Bayt lui-même** — la première Maison établie pour les gens. La Kiswa, elle, est un **tissu manufacturé par des humains**, périodiquement remplacé, historiquement variable dans sa couleur, son origine, sa matière. La racine *k-s-w* dans le Coran **n'autorise même pas** à associer ce mot à l'édifice. Étendre le statut *mubārak* du Bayt à un tissu qui le recouvre revient à appliquer la qualification coranique à un objet que **le Coran ne nomme pas, ne décrit pas, n'évoque pas**." %}

{% include callout.html type="contra" label="Invalidité 2 — La baraka du mubārak se manifeste fonctionnellement, jamais par contact" content="Pour le Bayt spécifiquement, le texte précise ce que l'on *fait* auprès de lui : *al-ṭawāf* (22:29 ; 2:125) · *al-ṣalāt* auprès du *maqām Ibrāhīm* (2:125) · *al-iʿtikāf* (2:125 ; 22:26) · *al-rukūʿ wa-l-sujūd* (2:125 ; 22:26) · *ṭahhirā baytiya* (2:125 ; 22:26). **Aucun de ces actes n'est un acte de contact rituel avec un revêtement.** Le Coran prescrit des actes d'orientation et de mouvement *autour* du Bayt, jamais des actes de captation matérielle." %}

{% include callout.html type="contra" label="Invalidité 3 — Inversion morphologique de l'ordre coranique" content="L'acte *tabarraka bi-l-kiswa* place morphologiquement la Kiswa en position d'émetteur de baraka. Or la position d'émetteur de baraka — source intrinsèque, autonome — est ce que la forme *tabāraka* désigne, et **cette forme ne s'emploie que pour Allaah** (Ibn Manẓūr). Faire de la Kiswa une source de baraka, c'est lui attribuer fonctionnellement ce que la morphologie arabe et l'usage coranique réservent exclusivement à Allaah. **La pratique de tabarruk bi-l-kiswa ne se contente pas d'être absente du texte : elle est en collision directe avec ce que le texte établit de la baraka.**" %}

---

## Partie IX · Identification coranique du raisonnement de l'intermédiation

{% include verset.html ref="Sourate 39 · Al-Zumar · v. 3 — Le raisonnement de l'intermédiation cité nommément" ar="أَلَا لِلَّهِ الدِّينُ الْخَالِصُ ۚ وَالَّذِينَ اتَّخَذُوا مِن دُونِهِ أَوْلِيَاءَ مَا نَعْبُدُهُمْ إِلَّا لِيُقَرِّبُونَا إِلَى اللَّهِ زُلْفَىٰ ۚ إِنَّ اللَّهَ لَا يَهْدِي مَنْ هُوَ كَاذِبٌ كَفَّارٌ" trl="*Alā li-llāhi d-dīnu l-khāliṣ — wa-lladhīna ttakhadhū min dūnihi awliyāʾa — **mā naʿbuduhum illā li-yuqarribūnā ilā llāhi zulfā** — inna llāha lā yahdī man huwa **kādhibun kaffār***" trad="N'est-ce pas qu'à Allaah appartient le *dīn* pur — et ceux qui ont pris des *awliyāʾ* en dehors de Lui [disent] : **« Nous ne les vénérons que pour qu'ils nous rapprochent d'Allaah. »** — Allaah ne guide pas celui qui est **menteur et ingrat**." %}

{% include callout.html type="contra" label="Le raisonnement du tabarruk littéralement cité" content="Ce verset cite **littéralement** le raisonnement de tout acte de *tabarruk* par intermédiaire : *« nous ne cherchons pas la baraka de la créature directement — nous l'utilisons pour nous rapprocher d'Allaah »*. Le Coran connaît cet argument. Il le cite mot pour mot. Et il lui applique les termes les plus sévères : *kādhibun kaffār* — **menteur et ingrat**. L'argument de l'intermédiaire de rapprochement **n'est pas une zone grise dans le Coran : c'est une zone de condamnation explicite.**" %}

{% include verset.html ref="Sourate 42 · Al-Shūrā · v. 21" ar="أَمْ لَهُمْ شُرَكَاءُ شَرَعُوا لَهُم مِّنَ الدِّينِ مَا لَمْ يَأْذَن بِهِ اللَّهُ" trl="*Am lahum **shurakāʾu sharaʿū lahum mina d-dīni** mā lam yaʾdhan bihi llāh*" trad="Ont-ils des **associés qui leur ont prescrit dans le *dīn*** ce qu'Allaah n'a pas autorisé ?" %}
...
{% include callout.html type="nondit" label="Pourquoi ce n'est pas un simple excès de dévotion" content="**Première raison — La sincérité ne reconfigure pas la structure.** Le verset 39:3 suppose précisément la sincérité de ceux qui formulent l'argument — *mā naʿbuduhum illā li-yuqarribūnā* est un argument de croyants se croyant fidèles. Le Coran ne le réfute pas en mettant en doute leur sincérité ; il le réfute en identifiant la **structure de leur acte**.
