---
layout: etude
title: "Le Ḥajj et la ʿUmra dans le Coran"
...
<div class="declaration">
  <span class="declaration__label">Déclaration préliminaire d'honnêteté</span>
  <p>Cette étude conduit à des conclusions structurellement très éloignées de la pratique actuelle du ḥajj. Ce n'est pas un choix polémique — c'est la conséquence nécessaire et honnête d'une lecture méthodique du texte. La méthode cartographie ce que le texte dit et nomme les silences comme silences, les inférences comme inférences. Ce document est une cartographie de compréhension, non une fatwa.</p>
</div>
...
{% include nl.html racine="ح · ج · ج" contenu="
...
{% include callout.html type="dit" label="Ce que les trois sources établissent" content="*Ḥajj* = mouvement intentionnel, délibéré, mené à son terme vers une destination référentielle. La racine définit la démarche, non le contenu du rite. Un ḥajj sans achèvement n'est pas un ḥajj — d'où la prescription *atimmū l-ḥajja* (2:196)." %}

### § 2 · La racine ʿ-M-R (*ʿumra*)
{: .section__title }

{% include nl.html racine="ع · م · ر" contenu="
...
{% include callout.html type="dit" label="Ce que les trois sources établissent" content="*ʿUmra* = visite qui anime, qui habite, qui fait vivre un lieu. L'accent est sur la présence active et vivifiante — non sur un rite à accomplir dans un délai fixé." %}
...
{% include verset.html ref="Sourate 2 · Al-Ijāba · v. 196 (extrait)" ar="وَأَتِمُّوا الْحَجَّ وَالْعُمْرَةَ لِلَّهِ" trl="*Wa-atimmū **l-ḥajja wa-l-ʿumrata** li-llāh*" trad="Accomplissez pleinement **le ḥajj et la ʿumra** pour Allaah." %}

{% include callout.html type="pivot" label="Point pivot — la ʿumra comme chemin vers le ḥajj" content="2:196 décrit le *mutamattiʿ* comme *tamataaʿa bi-l-ʿumrati **ilā** l-ḥajji* — la ʿumra est un chemin **vers** le ḥajj, non un rite autonome. La « petite ʿumra » accomplie indépendamment à tout moment de l'année est une construction de la tradition juridique sans fondement textuel direct." %}
...
{% include verset.html ref="Sourate 2 · v. 189" ar="يَسْأَلُونَكَ عَنِ الْأَهِلَّةِ ۚ قُلْ هِيَ مَوَاقِيتُ لِلنَّاسِ وَالْحَجِّ" trl="*Yasʾalūnaka ʿan **il-ahillati** — qul hiya **mawāqītu** li-n-nāsi wa-l-ḥajj*" trad="Ils t'interrogent sur les **croissants de lune**. Dis : ce sont des **jalons temporels précis** pour les gens et pour le **ḥajj**." %}

{% include callout.html type="dit" label="Dit" content="Les croissants lunaires visibles (*ahilla*) délimitent le temps pour les hommes et pour le ḥajj. La période du ḥajj est délimitée par l'observation du *hilāl* — accessible à tout observateur humain en tout lieu, sans calcul savant." %}

### § 5 · Des mois — non un jour — 2:197
{: .section__title }

{% include verset.html ref="Sourate 2 · v. 197 (extrait)" ar="الْحَجُّ أَشْهُرٌ مَّعْلُومَاتٌ" trl="*Al-ḥajju **ashhrun maʿlūmāt***" trad="Le ḥajj se tient sur **des mois connus**." %}

{% include nl.html contenu="***Ashhur*** : pluriel de *shahr* — mois lunaires. En arabe classique, le pluriel désigne au minimum deux, le plus souvent trois. ***Maʿlūmāt*** : connus des destinataires — le texte **ne les nomme pas**." %}

{% include callout.html type="nondit" label="Silence majeur" content="Les mois du ḥajj ne sont pas nommés dans le Coran. Leur identification conventionnelle (Shawwāl, Dhū l-Qaʿda, Dhū l-Ḥijja) est une convention de la tradition — non une donnée textuelle de 2:197." %}
...
{% include verset.html ref="Sourate 3 · v. 96–97" ar="إِنَّ أَوَّلَ بَيْتٍ وُضِعَ لِلنَّاسِ لَلَّذِي بِبَكَّةَ مُبَارَكًا وَهُدًى لِّلْعَالَمِينَ ۝ وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا" trl="*Inna awwala baytin wuḍiʿa li-l-nāsi la-lladhī bi-**Bakkata** mubārakan wa-hudan li-l-ʿālamīn… wa-li-llāhi ʿalā l-nāsi **ḥijju l-bayt** — mani stṭāʿa ilayhi **sabīlā***" trad="Le premier bayt établi pour les gens — c'est celui qui est à **Bakka**… C'est une obligation envers Allaah : **le ḥajj vers al-Bayt** — pour celui qui a la **capacité d'y trouver un chemin**." %}

{% include callout.html type="dit" label="Dit" content="L'obligation est conditionnée à la *istitāʿa* — capacité réelle d'y trouver un chemin (*sabīl*). La sécurité du chemin est une condition implicite. **« Une fois dans la vie »** : non dit — le texte ne précise pas de fréquence." %}

### § 7 · Égalité d'accès absolue — 22:25
{: .section__title }

{% include verset.html ref="Sourate 22 · v. 25" ar="الَّذِي جَعَلْنَاهُ لِلنَّاسِ سَوَاءً الْعَاكِفُ فِيهِ وَالْبَادِ" trl="*Alladhī jaʿalnāhu li-l-nāsi **sawāʾan al-ʿākifu fīhi wa-l-bād***" trad="Celui que Nous avons établi pour les gens — **à égalité : le résident et le pèlerin de passage**." %}

{% include callout.html type="dit" label="Dit" content="Al-Masjid al-Ḥarām est pour tous les gens à égalité absolue. Tout régime de quota ou de restriction d'accès par nationalité contredit structurellement ce verset." %}

### § 8 · ʿArafāt et al-Mashʿar al-Ḥarām — 2:198
{: .section__title }

{% include verset.html ref="Sourate 2 · v. 198" ar="فَإِذَا أَفَضْتُم مِّنْ عَرَفَاتٍ فَاذْكُرُوا اللَّهَ عِندَ الْمَشْعَرِ الْحَرَامِ" trl="*Fa-idhā **afaḍtum min ʿArafātin** fa-dhkurū llāha ʿinda **l-mashʿari l-ḥarām***" trad="Quand vous vous **répandez depuis ʿArafāt**, invoquez le souvenir d'Allaah auprès de **al-Mashʿar al-Ḥarām**." %}

{% include callout.html type="nondit" label="Silences sur ʿArafāt" content="Durée du séjour : non prescrite. Heure d'arrivée ou de départ : non prescrite. Le *wuqūf* minuté (de midi au coucher du soleil) : non prescrit. **Muzdalifa** : non nommée — al-Mashʿar al-Ḥarām est dit, pas Muzdalifa. **Minā** : absente des prescriptions. La **lapidation des *jamrāt*** : absente du Coran entier." %}

### § 9 · Les jours comptés — 2:203
{: .section__title }

{% include verset.html ref="Sourate 2 · v. 203" ar="فَمَن تَعَجَّلَ فِي يَوْمَيْنِ فَلَا إِثْمَ عَلَيْهِ وَمَن تَأَخَّرَ فَلَا إِثْمَ عَلَيْهِ" trl="*Fa-man taʿajjala fī **yawmayni** fa-**lā ithma ʿalayh** — wa-man taʾakhkhara fa-**lā ithma ʿalayh***" trad="Celui qui se presse en **deux jours** — **aucun tort**. Celui qui reste plus — **aucun tort**." %}

{% include callout.html type="dit" label="Dit" content="Deux options sans faute : partir après deux jours, ou rester plus longtemps. Le texte ne prescrit pas un nombre fixe de jours obligatoires." %}
...
| 9 | Immolation des *budn* — *maḥill* : auprès du Bayt | 22:33–36 | **Pas à Minā** dans le texte |
...
{% include callout.html type="warn" label="Lecture des trois tableaux" content="Sur 15 étapes recensées dans le Tableau 1, **4 ont une base coranique directe** (ṭawāf, rasage, hadī, passage par ʿArafāt), **2 ont une base partielle** (interdictions de l'iḥrām, saʿy comme permission), et **9 sont extra-coraniques**. Ce constat ne juge pas ces pratiques — il les cartographie." %}
...
{% include callout.html type="silence" label="Silence total du texte" content="Le Coran ne mentionne pas *al-ḥajar al-aswad* — nulle part, aucune occurrence. Aucune prescription d'embrasser, de toucher ou de s'approcher d'une pierre dans la Ka'ba." %}
...
{% include callout.html type="contra" label="Contradiction dans les sources traditionnelles" content="ʿUmar ibn al-Khaṭṭāb (Bukhārī n° 1520, Muslim n° 1720) : *« Inni aʿlamu annaka ḥajarun lā taḍurru wa-lā tanfaʿ »* — « Je sais que tu es une pierre qui ne peut ni nuire ni profiter. » La tradition se réfute elle-même dans ses sources les plus canoniques." %}

### § 11 · Al-Kiswa — silence coranique total
{: .section__title }

{% include callout.html type="silence" label="Silence total du texte" content="Le couvrement de la Ka'ba (*al-kiswa*) n'est mentionné nulle part dans le Coran. 22:26 prescrit *wa-ṭahhir baytī* — purifie Mon Bayt. Le couvrement n'est pas mentionné comme modalité de cette purification." %}
...
{% include callout.html type="inf" label="Inférence forte — Bakka = Makka ou parties du même lieu" content="**Argument 1** : 3:96 localise al-Bayt à Bakka avec la station d'Ibrāhīm. 48:24–25 mentionne Makka et al-Masjid al-Ḥarām dans le même contexte. Un seul ensemble dans tout le corpus : Bayt + Masjid al-Ḥarām + station d'Ibrāhīm.
...
{% include callout.html type="nondit" label="Réfutation depuis le texte — 5 arguments" content="
...
{% include callout.html type="pivot" label="Conclusion" content="L'hypothèse Bakka = Jérusalem ne peut pas s'appuyer sur le Coran lui-même. Elle repose exclusivement sur des arguments extra-coraniques. L'inférence Bakka = Makka est de loin la lecture la plus cohérente avec l'ensemble du corpus." %}
...
{% include verset.html ref="Sourate 22 · v. 37" ar="لَن يَنَالَ اللَّهَ لُحُومُهَا وَلَا دِمَاؤُهَا وَلَٰكِن يَنَالُهُ التَّقْوَىٰ مِنكُمْ" trl="***Lan yanāla llāha luḥūmuhā wa-lā dimāʾuhā** — wa-lākin yanāluhu **l-taqwā** minkum*" trad="**Ni leurs chairs ni leurs sangs n'atteignent Allaah** — c'est votre ***taqwā*** qui L'atteint." %}

{% include callout.html type="pivot" label="Verset pivot — négation catégorique lan" content="La particule *lan* exprime l'impossibilité structurelle et définitive. Ce verset désamorce toute interprétation propitiatoire du sacrifice. La finalité est alimentaire et sociale (22:28). L'*udhiya* universelle, l'*ʿĪd al-Aḍḥā* et les récompenses eschatologiques par poil d'animal sont des constructions extra-coraniques." %}

{% include callout.html type="contra" label="Contradiction frontale" content="Le ḥadīth fondateur de l'*ʿĪd al-Aḍḥā* (at-Tirmidhī, qualifié de *gharīb* par at-Tirmidhī lui-même) affirme : *« le sang atteint sa place auprès d'Allaah avant de toucher le sol. »* S.22:37 dit par *lan* : *« les sangs n'atteignent pas Allaah. »* La contradiction est frontale et directe." %}
...
{% include callout.html type="warn" label="Méthode d'examen" content="Un ḥadīth peut être qualifié de *ṣaḥīḥ* et contredire le Coran — ces deux constats appartiennent à des registres distincts. La méthode islamducoran.fr utilise le Coran comme seul référentiel normatif." %}
...
{% include callout.html type="dit" label="Ce que le Coran dit effectivement" content="S.2:197 : *wa-mā tafʿalū min khayrin yaʿlamhu llāh* — tout bien que vous faites, Allaah le connaît. Et : *fa-inna khayra l-zādi l-taqwā* — la meilleure des provisions est la *taqwā*. Le texte ne promet pas de récompense arithmétique." %}
...
{% include callout.html type="pivot" label="Observation structurelle — organisation actuelle vs prescriptions coraniques" content="
...
{% include callout.html type="dit" label="Ce que le Coran dit explicitement — 15 points" content="
...
<div class="declaration">
  <span class="declaration__label">Note de clôture</span>
  <p>Le ḥajj coranique est un mouvement intentionnel vers al-Bayt, accompagné d'une présence vivifiante, délimité par des mois lunaires observables, passant par ʿArafāt et al-Mashʿar al-Ḥarām, comprenant le ṭawāf et l'orientation intérieure qui donne sens au sacrifice. La très grande majorité des gestes rituels de la pratique actuelle ne se trouvent pas dans ce texte. Ce qu'elle dit — et ce qu'elle seule peut dire — c'est que ces prescriptions ne viennent pas du Coran.</p>
</div>
