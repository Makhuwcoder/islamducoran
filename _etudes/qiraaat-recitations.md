...
{% include callout.html type="contra" label="La manipulation identifiée" content="La manipulation consiste à faire passer la pluralité des *qirāʾāt* — variation phonétique sur un *rasm* unique — pour une pluralité de *textes* concurrents. **Il n'y a pas plusieurs textes : il y a un seul texte, et plusieurs façons attestées de le prononcer.**
...
{% include verset.html ref="Sourate 15 · Al-Ḥijr · v. 9" ar="إِنَّا نَحْنُ نَزَّلْنَا ٱلذِّكْرَ وَإِنَّا لَهُۥ لَحَٰفِظُونَ" trl="*Innā naḥnu nazzalnā **l-dhikra** — wa-innā lahu **la-ḥāfiẓūn***" trad="C'est Nous qui avons descendu le ***dhikr*** — et c'est Nous qui en sommes les ***ḥāfiẓūn*** (gardiens)." %}

{% include verset.html ref="Sourate 41 · Fuṣṣilat · v. 41–42" ar="وَإِنَّهُۥ لَكِتَٰبٌ عَزِيزٌ ۝ لَّا يَأْتِيهِ ٱلْبَٰطِلُ مِنۢ بَيْنِ يَدَيْهِ وَلَا مِنْ خَلْفِهِۦ" trl="*Wa-innahu la-kitābun ʿazīz — **lā ya'tīhi l-bāṭilu min bayni yadayhi wa-lā min khalfih***" trad="Certes c'est un Livre puissant — **le faux ne peut l'atteindre ni par devant ni par derrière**." %}

{% include nl.html contenu="La déclaration de préservation de 15:9 porte sur ***al-dhikr*** — le rappel, le message. Le pronom *lahu* renvoie à *al-dhikr* dans son essence — non à *al-lafẓ al-ʿarabī*, la formulation arabe spécifique. **Si la préservation était limitée à la version arabe, il faudrait que le verset dise *wa-innā li-lafẓihi l-ʿarabī la-ḥāfiẓūn* — ce n'est pas ce que dit le texte.**" %}
...
{% include verset.html ref="Sourate 2 · Al-Baqara · v. 159" ar="إِنَّ ٱلَّذِينَ يَكْتُمُونَ مَآ أَنزَلْنَا مِنَ ٱلْبَيِّنَٰتِ وَٱلْهُدَىٰ … أُو۟لَٰٓئِكَ يَلْعَنُهُمُ ٱللَّهُ" trl="*Inna l-ladhīna **yaktumūna** mā anzalnā … ulāʾika yalʿanahumu llāh*" trad="Ceux qui **dissimulent** ce que Nous avons descendu parmi les preuves claires et la guidance … ceux-là, Allaah les exclut." %}

{% include verset.html ref="Sourate 62 · Al-Jumuʿa · v. 5" ar="مَثَلُ ٱلَّذِينَ حُمِّلُوا۟ ٱلتَّوْرَىٰةَ ثُمَّ لَمْ يَحْمِلُوهَا كَمَثَلِ ٱلْحِمَارِ يَحْمِلُ أَسْفَارًا" trl="*Mathalu l-ladhīna ḥummilū l-tawrāta thumma **lam yaḥmilūhā** — ka-mathali l-ḥimāri yaḥmilu asfāra*" trad="L'exemple de ceux qui ont été chargés de la Torah puis **ne l'ont pas portée** — est comme l'exemple de l'âne qui porte des volumes." %}
...
2. Le faux ne peut atteindre le Livre ni par devant ni par derrière (41:42)
3. La préservation porte sur le *dhikr* — le message — dont le pronom *lahu* ne restreint pas la portée à la formulation arabe
4. La diversité des langues est un signe d'Allaah — non une hiérarchie (30:22)
5. Tout messager est envoyé dans la langue de son peuple pour l'expliquer clairement (14:4)
6. **Le *rasm* du Coran est identique dans tous les muṣḥaf** — fait factuel vérifiable" %}
...
{% include callout.html type="inf" label="Inférences identifiées comme telles — à rejeter" content="
...
<div class="declaration">
  ...
  <p>Cette étude s'appuie exclusivement sur le texte du Coran et la lexicographie classique. Elle distingue les effets observables des intentions supposées : seuls les premiers sont évaluables par le texte. Les conclusions sont des propositions cartographiques, non des prescriptions.</p>
</div>
