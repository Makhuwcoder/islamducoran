...
<div class="declaration">
  <span class="declaration__label">Cadre méthodologique</span>
  <p>Aucune source extérieure au Coran — ḥadīth, fiqh, tafsīr — n'est convoquée comme autorité normative. La méthode est : Coran seul · Arabe classique. Les conclusions constituent une cartographie de compréhension — non un prescrit, non un jugement. Elles sont non-dogmatiques et révisables. Chaque conclusion est signalée selon sa nature : prescription textuelle directe, inférence légitime, ou addition de la tradition.</p>
</div>
...
{% include nl.html racine="ز · ك · و / ز · ك · ي" contenu="
...
{% include callout.html type="dit" label="Ce que la racine dit" content="La racine porte un **double sens qualitatif** : purification et croissance. Donner purifie le bien restant et le fait croître." %}

{% include callout.html type="nondit" label="Ce que la racine ne dit pas" content="La racine ne précise ni montant, ni taux, ni fréquence, ni calendrier. Le sens premier est **qualitatif**, pas quantitatif ou comptable." %}
...
{% include verset.html ref="Sourate 2 · Al-Baqara · v. 43" ar="وَأَقِيمُوا الصَّلَاةَ وَآتُوا الزَّكَاةَ وَارْكَعُوا مَعَ الرَّاكِعِينَ" trl="*Wa-aqīmū ṣ-ṣalāta — wa-**ātū z-zakāta** — wa-rkaʿū maʿa r-rākiʿīn*" trad="Établissez la *ṣalāt* — et **faites parvenir la *zakāt*** — et inclinez-vous avec ceux qui s'inclinent." %}

{% include nl.html contenu="***Ātā / ātu*** (آتَى / آتُوا) — Al-Farāhīdī : *ātā* = il a fait parvenir, il a remis effectivement. L'acte est concret — la remise réelle, non un engagement futur. Ibn Fāris : racine **ʾ-t-y** = venir vers, amener à, faire parvenir. Aucune notion de délai, de seuil ou de taux dans la racine." %}
...
{% include verset.html
  ref="Sourate 9 · Al-Tawba · v. 60 — Verset central de la zakāt"
  ar="إِنَّمَا الصَّدَقَاتُ لِلْفُقَرَاءِ وَالْمَسَاكِينِ وَالْعَامِلِينَ عَلَيْهَا وَالْمُؤَلَّفَةِ قُلُوبُهُمْ وَفِي الرِّقَابِ وَالْغَارِمِينَ وَفِي سَبِيلِ اللَّهِ وَابْنِ السَّبِيلِ ۖ فَرِيضَةً مِّنَ اللَّهِ ۗ وَاللَّهُ عَلِيمٌ حَكِيمٌ"
  trl="***Innamā** ṣ-ṣadaqātu li-l-fuqarāʾi wa-l-masākīni wa-l-ʿāmilīna ʿalayhā wa-l-muʾallafati qulūbuhum wa-fī r-riqābi wa-l-ghārimīna wa-fī sabīli llāhi wa-bni s-sabīli — **farīḍatan mina llāhi** — wa-llāhu ʿAlīmun Ḥakīm*"
  trad="***Les *ṣadaqāt* ne sont destinées qu'aux** *fuqarāʾ*, aux *masākīn*, à ceux qui en assurent la gestion, à ceux dont les cœurs sont en voie d'être rapprochés, pour la libération des personnes en servitude, aux écrasés de dettes, pour ce qui est dans la voie d'Allaah, et au voyageur en rupture de ressources — **une obligation prescrite par Allaah** (*farīḍatan mina llāhi*) — Allaah est *ʿAlīmun Ḥakīm*.*"
%}

{% include callout.html type="pivot" label="Pivot grammatical — innamā" content="**Innamā (إِنَّمَا)** est une particule de restriction exclusive : « ne... que ». La liste est fermée par **farīḍatan mina llāhi** (obligation prescrite par Allaah). Le texte nomme les bénéficiaires et les ferme. Il ne nomme pas le montant et ne le ferme pas — ce silence est structurellement significatif." %}
...
{% include callout.html type="dit" label="Ce que le texte dit" content="**La condition de foi n'est mentionnée pour aucune des catégories définies par un état matériel.** Cinq catégories sur huit sont définies exclusivement par un état de besoin ou de fonction — sans référence à la confession." %}

---

## IV · Le muslim peut-il donner la zakāt à un non-muslim ?

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 272" ar="لَيْسَ عَلَيْكَ هُدَاهُمْ وَلَٰكِنَّ اللَّهَ يَهْدِي مَن يَشَاءُ ۗ وَمَا تُنفِقُوا مِنْ خَيْرٍ فَلِأَنفُسِكُمْ ۚ وَمَا تُنفِقُونَ إِلَّا ابْتِغَاءَ وَجْهِ اللَّهِ" trl="*Laysa ʿalayka hudāhum — wa-mā tunfiqū min khayrin fa-li-anfusikum — wa-mā tunfiqūna illā btighāʾa **wajhi llāhi***" trad="Tu n'es pas responsable de leur guidance — ce que vous dépensez en bien, c'est pour vous-mêmes — vous ne dépensez que pour tendre vers **ce qui revient à Allaah** (*wajhu llāh*)." %}

{% include callout.html type="pivot" label="Pivot intra-coranique — S.2:272" content="Ce verset établit un principe clair : **la guidance du bénéficiaire n'est pas une condition préalable** à la dépense. La dépense est orientée vers ce qui revient à Allaah (*wajhu llāh*) — pas vers la foi de celui qui reçoit." %}

{% include verset.html ref="Sourate 60 · Al-Mumtaḥana · v. 8" ar="لَّا يَنْهَاكُمُ اللَّهُ عَنِ الَّذِينَ لَمْ يُقَاتِلُوكُمْ فِي الدِّينِ وَلَمْ يُخْرِجُوكُم مِّن دِيَارِكُمْ أَن تَبَرُّوهُمْ وَتُقْسِطُوا إِلَيْهِمْ ۚ إِنَّ اللَّهَ يُحِبُّ الْمُقْسِطِينَ" trl="*Lā yanhākumu llāhu ʿani lladhīna lam yuqātilūkum fī d-dīni — an **tabarrūhum** wa-**tuqsiṭū ilayhim** — inna llāha yuḥibbu l-muqsiṭīn*" trad="Allaah ne vous interdit pas, à l'égard de ceux qui ne vous ont pas combattus dans le *dīn*, que vous agissiez envers eux avec **bienfaisance** (*tabarrūhum*) et que vous soyez **équitables** envers eux. Allaah honore et récompense ceux qui font preuve d'équité." %}

{% include callout.html type="dit" label="Ce que le texte dit sur le non-muslim" content="Il n'existe aucun verset posant la condition d'être *muslim* pour recevoir la *zakāt*. Aucun verset n'interdit de donner la *zakāt* à un non-*muslim*. Le texte définit les catégories bénéficiaires par des états matériels. S.2:272 délie la dépense de la foi du bénéficiaire. S.60:8 prescrit la bienfaisance envers les non-*muslimūn* qui ne combattent pas. **L'interdiction est une addition de *fiqh*, non une obligation coranique.**" %}
...
{% include verset.html
  ref="Sourate 6 · Al-Anʿām · v. 141"
  ar="كُلُوا مِن ثَمَرِهِ إِذَا أَثْمَرَ وَآتُوا حَقَّهُ يَوْمَ حَصَادِهِ وَلَا تُسْرِفُوا"
  trl="*Kulū min thamarihi idhā athmara — wa-**ātū ḥaqqahu yawma ḥaṣādihi** — wa-lā tusrifū*"
  trad="Mangez de ses fruits quand il donne ses fruits — et **faites parvenir ce qui lui revient le jour de sa récolte** — et ne soyez pas dans l'excès."
%}
...
{% include callout.html type="dit" label="Ce que le texte dit sur le moment" content="S.6:141 fixe le moment : **yawma ḥaṣādihi** — le jour de la récolte, c'est-à-dire au moment de la réception du bien. Le déclencheur n'est pas une date calendaire — c'est l'acte même de recevoir. **Le *ḥawl* (an de possession) est absent du Coran.**" %}

---

## VI · Le montant — S.2:219

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 219 (extrait)" ar="وَيَسْأَلُونَكَ مَاذَا يُنفِقُونَ ۖ قُلِ الْعَفْوَ" trl="*Wa-yasʾalūnaka mādhā yunfiqūn — **Quli l-ʿafw***" trad="Et ils te demandent : « Que dépenser ? » — **Dis : ce qui est au-delà de tes besoins** (*al-ʿafw*)." %}

{% include nl.html contenu="***Al-ʿafw*** (الْعَفْو) — Al-Farāhīdī (*Kitāb al-ʿAyn*) : ce qui excède, ce qui dépasse la limite nécessaire, ce qui est en surplus après satisfaction du besoin essentiel. Ibn Fāris (*Maqāyīs*) : racine **ʿ-f-w** = deux axes : effacement et abondance. *Al-ʿafw* ici = ce qui pousse en surplus. Ibn Manẓūr (*Lisān*) : *anfiqi l-ʿafw* = dépense ce qui est en surplus après tes besoins." %}

{% include callout.html type="dit" label="Ce que le texte dit sur le montant" content="S.2:219 fixe le montant : **al-ʿafw** — ce qui excède les besoins. Pas un taux fixe : une mesure **personnelle et contextuelle**. La réponse du texte à « combien ? » est **qualitative**, pas comptable." %}

---

## VII · La logique coranique en trois temps

{% include callout.html type="pivot" label="Cohérence intra-coranique" content="
...
{% include callout.html type="warn" label="État des lieux honnête — additions ḥadīthiques" content="
...
{% include callout.html type="inf" label="Inférences légitimes — signalées comme telles" content="
