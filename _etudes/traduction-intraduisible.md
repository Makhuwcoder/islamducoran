...
{% include verset.html ref="Sourate 54 · Al-Qamar · v. 17, 22, 32, 40 — répété quatre fois" ar="وَلَقَدْ يَسَّرْنَا ٱلْقُرْءَانَ لِلذِّكْرِ فَهَلْ مِن مُّدَّكِرٍ" trl="*Wa-laqad **yassarnā l-Qurʾāna** li-l-dhikri — fa-hal min **muddakir***" trad="Et Nous avons certes **facilité le Coran** pour le rappel — y a-t-il quelqu'un qui **se rappelle** (*muddakir*) ?" %}

{% include callout.html type="contra" label="Le dilemme logique de l'intraduisibilité" content="
...
{% include verset.html ref="Sourate 41 · Fuṣṣilat · v. 44" ar="وَلَوْ جَعَلْنَٰهُ قُرْءَانًا أَعْجَمِيًّا لَّقَالُوا۟ لَوْلَا فُصِّلَتْ ءَايَٰتُهُۥٓ ءَا۬عْجَمِىٌّ وَعَرَبِىٌّ ۗ قُلْ هُوَ لِلَّذِينَ ءَامَنُوا۟ هُدًى وَشِفَآءٌ" trl="*Wa-law jaʿalnāhu qurʾānan **aʿjamiyyan** — la-qālū lawlā fuṣṣilat āyātuhu — a-ʿajamiyyun wa-ʿarabī — qul **huwa li-l-ladhīna āmanū hudan wa-shifāʾ***" trad="Et si Nous en avions fait un Coran en **langue non-arabe** — ils auraient dit : pourquoi ses versets ne sont-ils pas détaillés ? Non-arabe et arabe ? — Dis : **il est, pour ceux qui ont cru, guidance et guérison**." %}

{% include callout.html type="dit" label="Trois leçons de S.41:44" content="
1. **Accommodation, non privilège** : Allaah révèle Lui-même la logique du choix linguistique. La langue arabe n'est pas choisie parce qu'elle est supérieure — elle est choisie pour lever un obstacle prévisible. **C'est une accommodation pragmatique faite à une faiblesse que le texte lui-même diagnostique.**
2. **La mauvaise foi exposée** : La formule *a-ʿajamiyyun wa-ʿarabī* est la reconstitution ironique de l'objection prévisible. L'argument linguistique est exposé comme un prétexte — non une raison de fond.
3. **Le destinataire : la foi, non la langue** : *Huwa li-l-ladhīna āmanū hudan wa-shifāʾ* — **le destinataire réel du Coran est défini par la foi. *Li-l-ladhīna āmanū* est universel : ceux qui ont cru, quelle que soit leur langue.**" %}

{% include verset.html ref="Sourate 14 · Ibrāhīm · v. 4" ar="وَمَآ أَرْسَلْنَا مِن رَّسُولٍ إِلَّا بِلِسَانِ قَوْمِهِۦ لِيُبَيِّنَ لَهُمْ" trl="*Wa-mā arsalnā min rasūlin **illā bi-lisāni qawmihi** — **li-yubayyina lahum***" trad="Et Nous n'avons envoyé aucun messager **sinon dans la langue de son peuple** — **pour qu'il leur explique clairement**." %}

{% include callout.html type="dit" label="Le principe structurel d'Allaah pour l'envoi de Ses messagers" content="**La finalité du message est la clarté, non le mystère.** Un message envoyé pour être compris est un message traduisible par principe. C'est la réfutation structurelle de toute théologie de l'inaccessibilité." %}

---

## IV · Le défi du Coran : *inimitable* ≠ *intraduisible*

{% include verset.html ref="Sourate 2 · Al-Baqara · v. 23" ar="فَأْتُوا۟ بِسُورَةٍ مِّن مِّثْلِهِۦ" trl="***Fa-ʾtū bi-sūratin min mithlihi***" trad="**Apportez une sourate semblable**." %}

{% include callout.html type="nondit" label="Ce que le défi ne dit pas" content="Le défi coranique porte sur la **production** — *fa-ʾtū* : produisez. Il ne dit pas que le Coran serait intraduisible ni que son sens serait inaccessible dans une autre langue. **La confusion entre *inimitable* et *intraduisible* est le cœur de la manipulation.** Le défi et la traduction sont deux notions entièrement distinctes que le texte ne confond jamais." %}

---

## V · La transmission en acte — S.46:29–31 et S.9:122

{% include verset.html ref="Sourate 46 · Al-Aḥqāf · v. 29–31" ar="فَلَمَّا قُضِيَ وَلَّوْا۟ إِلَىٰ قَوْمِهِم مُّنذِرِينَ ۝ يَٰقَوْمَنَآ إِنَّا سَمِعْنَا كِتَٰبًا … يَهْدِى إِلَى ٱلْحَقِّ وَإِلَىٰ طَرِيقٍ مُّسْتَقِيمٍ ۝ يَٰقَوْمَنَآ أَجِيبُوا۟ دَاعِىَ ٱللَّهِ وَءَامِنُوا۟ بِهِۦ" trl="*Falammā quḍiya wallaw ilā qawmihim **mundhirīn** — yā qawmanā innā samiʿnā kitāban … yahdī ilā l-ḥaqqi — yā qawmanā **ajībū dāʿiya llāhi wa-āminū bih***" trad="Puis, lorsque cela fut achevé, ils retournèrent vers leur peuple — en **avertisseurs** (*mundhirīn*) — Ô notre peuple ! nous avons entendu un Livre… qui guide vers la vérité — Ô notre peuple ! **Répondez à l'appelant d'Allaah et croyez en lui**." %}
...
{% include verset.html ref="Sourate 9 · Al-Tawba · v. 122" ar="فَلَوْلَا نَفَرَ مِن كُلِّ فِرْقَةٍ مِّنْهُمْ طَآئِفَةٌ لِّيَتَفَقَّهُوا۟ فِى ٱلدِّينِ وَلِيُنذِرُوا۟ قَوْمَهُمْ إِذَا رَجَعُوٓا۟ إِلَيْهِمْ" trl="*Falawlā nafara min kulli firqatin minhum ṭāʾifatun **li-yatafaqqahū fī d-dīni** — wa-**li-yundhirū qawmahum** idhā rajaʿū ilayhim*" trad="Pourquoi ne partirait-il pas de chaque groupe quelques personnes pour **acquérir une compréhension approfondie du *dīn*** — et pour **avertir leur peuple** lorsqu'elles retournent auprès d'eux ?" %}

{% include callout.html type="inf" label="Inférence légitime — nommée comme telle" content="Ces deux versets ne disent pas explicitement « traduisez le Coran ». Ce qu'ils disent : la transmission du message vers des peuples distincts est une structure que le texte met en scène et commande. La langue n'y est posée nulle part comme condition restrictive. **La traduction est l'inférence légitime que l'on tire de cette structure** — que rien dans le texte ne contredit, et que *wa-man balagha* (6:19) confirme par ailleurs." %}
...
<div class="declaration">
  <span class="declaration__label">Note finale</span>
  <p>Ce travail lui-même démontre que le Coran se traduit, à condition de deux compétences accessibles — la lexicographie classique et la rigueur du dit/non-dit. Ces deux compétences sont sans rapport avec une appartenance ethnique, une chaîne d'initiation, ou un *kashf* mystique. Elles sont au service du texte — non au-dessus de lui.</p>
