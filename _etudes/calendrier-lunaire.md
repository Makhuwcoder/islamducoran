...
{% include verset.html ref="Sourate 10 · Yūnus · v. 5" ar="هُوَ الَّذِي جَعَلَ الشَّمْسَ ضِيَاءً وَالْقَمَرَ نُورًا وَقَدَّرَهُ مَنَازِلَ لِتَعْلَمُوا عَدَدَ السِّنِينَ وَالْحِسَابَ" trl="*Huwa lladhī jaʿala **l-shamsa ḍiyāʾan** wa-**l-qamara nūran** wa-qaddarahu manāzila — **li-taʿlamū ʿadada l-sinīna wa-l-ḥisāba***" trad="C'est Lui qui a fait du **soleil une clarté** et de la **lune une lumière**, et Il lui a assigné des étapes — **afin que vous connaissiez le nombre des années et le calcul**." %}

{% include verset.html ref="Sourate 55 · Al-Raḥmān · v. 5" ar="الشَّمْسُ وَالْقَمَرُ بِحُسْبَانٍ" trl="***Al-shamsu wa-l-qamaru** bi-**ḥusbānin***" trad="**Le soleil et la lune** suivent un **calcul précis** (*ḥusbān*)." %}

{% include callout.html type="dit" label="Ce que ces versets disent ensemble" content="
...
{% include callout.html type="nondit" label="Ce que ces versets ne disent pas" content="
...
{% include nl.html contenu="***ʿIddat al-shuhūr*** — racine ع-د-د : Ibn Fāris : dénombrer, compter avec exactitude. *ʿIdda* est le décompte précis, le nombre fixé. L'affirmation de S.9:36 est catégorique : ce nombre est douze — ni onze, ni treize. Ce nombre est qualifié de *fī kitābi llāhi yawma khalaqa l-samāwāti wa-l-arḍa* — **inscrit dans le Livre d'Allaah dès la Création**. C'est une donnée cosmologique antérieure à l'humanité." %}
...
{% include callout.html type="dit" label="Verdict" content="S.9:36 ne prescrit pas le calendrier lunaire pur. Il prescrit le nombre douze. Un système luni-solaire maintenant exactement douze mois respecte S.9:36 aussi bien que le lunaire pur. Inférer l'exclusivité lunaire depuis ce verset est **ajouter au texte ce qu'il ne dit pas**." %}
...
{% include verset.html ref="Sourate 9 · Al-Tawba · v. 37" ar="إِنَّمَا النَّسِيءُ زِيَادَةٌ فِي الْكُفْرِ ۖ يُضَلُّ بِهِ الَّذِينَ كَفَرُوا يُحِلُّونَهُ عَامًا وَيُحَرِّمُونَهُ عَامًا لِّيُوَاطِئُوا عِدَّةَ مَا حَرَّمَ اللَّهُ فَيُحِلُّوا مَا حَرَّمَ اللَّهُ" trl="*Innamā **l-nasīʾu** ziyādatun fi-l-kufri — **yuḥillūnahu ʿāman wa-yuḥarrimūnahu ʿāman** — **li-yuwāṭiʾū** ʿiddata mā ḥarrama llāhu — **fa-yuḥillū mā ḥarrama llāhu***" trad="En vérité, le ***nasīʾ*** n'est qu'un surplus de *kufr* — **ils le déclarent licite une année et illicite une autre** — **afin de faire artificiellement coïncider** le nombre de ce qu'Allaah a déclaré sacré — **et ainsi rendre licite ce qu'Allaah a interdit**." %}
...
{% include nl.html contenu="***Al-ahilla*** — pluriel de *hilāl* (racine هـ-ل-ل) : le croissant lunaire visible à l'œil nu. ***Mawāqīt*** — pluriel de *mīqāt* (racine و-ق-ت) : délimiteur de temps précis, jalon fixé. Ce terme est fort : il dit que les croissants **délimitent précisément** le temps." %}
...
{% include callout.html type="dit" label="Verdict" content="S.2:189 est parfaitement compatible avec un calendrier luni-solaire. Les *ahilla* délimitent les mois, et le soleil fournit l'ancrage annuel. **Lire S.2:189 comme excluant le soleil, c'est lire ce verset *à la place* des trois autres au lieu de le lire *avec* eux.**" %}

---

## V · L'argument positif — ce que le lunaire pur ne peut pas rendre compte

{% include nl.html contenu="***Sinīn*** — pluriel de *sana* (racine س-ن-و) : Ibn Fāris : le cycle complet, la révolution entière. Dans l'usage classique, *sana* désigne préférentiellement **l'année solaire** par distinction avec *ʿām* (plus générique). Ibn Manẓūr confirme : *al-sana* est lié au parcours du soleil.
...
{% include callout.html type="contra" label="La question que le lunaire pur ne peut pas éviter" content="Si le calendrier exclusivement lunaire était la prescription coranique, pourquoi le Coran mentionne-t-il le soleil **trois fois** dans des contextes de computation temporelle (10:5, 55:5, 6:96) ? Le lunaire pur n'a pas de réponse à cette question — il doit traiter ces trois versets comme rhétoriques ou ornementaux. Notre méthode interdit d'effacer un dit textuel au profit d'une position préétablie." %}

---

## VI · Analogie méthodologique — le même mécanisme dans le débat du ribā

{% include verset.html ref="Sourate 3 · Āl ʿImrān · v. 130" ar="يَا أَيُّهَا الَّذِينَ آمَنُوا لَا تَأْكُلُوا الرِّبَا أَضْعَافًا مُّضَاعَفَةً" trl="*Yā ayyuhā lladhīna āmanū lā taʾkulū l-ribā — **aḍʿāfan muḍāʿafatan***" trad="Ô vous qui croyez, ne consommez pas le ribā — **multiplié et cumulé** (*aḍʿāfan muḍāʿafatan*)." %}

{% include callout.html type="pivot" label="La même structure d'erreur dans les deux débats" content="
...
| S.55:5 · S.6:96 | Soleil et lune dans un ***ḥusbān* unique** — *taqdir* d'Allaah | Que ce système est exclusivement lunaire |

{% include callout.html type="nondit" label="Ce que le texte coranique ne permet pas de dire" content="Que le calendrier lunaire pur est *prescrit* par le Coran. Cette prescription n'est pas dans le texte. Aucun verset ne condamne un ancrage astronomique régulier, transparent et non manipulable. Trois versets mentionnent explicitement le soleil et la lune ensemble comme instruments de la computation du temps." %}

<div class="declaration">
  <span class="declaration__label">Barāʾa</span>
  <p>Toutes les conclusions de ce document sont présentées comme une <em>cartographie de compréhension</em> — non dogmatique, non prescriptive, révisable. L'unique garant de la compréhension est Allaah.</p>
</div>
