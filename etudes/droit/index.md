---
layout: default
title: "Droit pénal & Économie islamique"
subtitle: "الْحُدُودُ وَالاقْتِصَاد"
permalink: /etudes/droit/
---

<div class="site-main">
  <div class="page-header">
    <div class="page-header__categorie" style="font-family:var(--font-arabe);font-size:1.4rem;color:var(--or3);margin-bottom:.5rem;direction:rtl;">الْحُدُودُ وَالاقْتِصَاد</div>
    <h1 class="page-header__titre">Droit pénal & Économie islamique</h1>
    <p class="page-header__subtitle">La zakāt, le ribā, la lapidation, le fasād — les prescriptions économiques et pénales du Coran.</p>
  </div>
  ...
  <div class="etudes-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.4rem;margin-top:2rem;">
    {% assign cat_etudes = site.etudes | where: "categorie_slug", "droit" | sort: "order" %}
