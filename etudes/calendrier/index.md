---
layout: default
title: "Calendrier & Temps cosmique"
subtitle: "التَّقْوِيمُ وَالزَّمَن"
permalink: /etudes/calendrier/
---

<div class="site-main">
  <div class="page-header">
    <div class="page-header__categorie" style="font-family:var(--font-arabe);font-size:1.4rem;color:var(--or3);margin-bottom:.5rem;direction:rtl;">التَّقْوِيمُ وَالزَّمَن</div>
    <h1 class="page-header__titre">Calendrier & Temps cosmique</h1>
    <p class="page-header__subtitle">Le calendrier islamique, le temps lunaire, l'état des lieux calendaire face au texte coranique.</p>
  </div>
  ...
  <div class="etudes-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.4rem;margin-top:2rem;">
    {% assign cat_etudes = site.etudes | where: "categorie_slug", "calendrier" | sort: "order" %}
