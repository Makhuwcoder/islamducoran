---
layout: default
title: "Autorité légifératrice & Sources"
subtitle: "السُّلْطَةُ التَّشْرِيعِيَّةُ وَالْمَصَادِر"
permalink: /etudes/sources/
---

<div class="site-main">
  <div class="page-header">
    <div class="page-header__categorie" style="font-family:var(--font-arabe);font-size:1.4rem;color:var(--or3);margin-bottom:.5rem;direction:rtl;">السُّلْطَةُ التَّشْرِيعِيَّةُ وَالْمَصَادِر</div>
    <h1 class="page-header__titre">Autorité légifératrice & Sources</h1>
    <p class="page-header__subtitle">Le ḥadīth, la sunna, la fatwā, le naskh, les sources du dīn et la question de l'autorité normative.</p>
  </div>
  ...
  <div class="etudes-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.4rem;margin-top:2rem;">
    {% assign cat_etudes = site.etudes | where: "categorie_slug", "sources" | sort: "order" %}
