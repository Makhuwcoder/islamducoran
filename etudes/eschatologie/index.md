---
layout: default
title: "Eschatologie & Métaphysique"
subtitle: "الْآخِرَةُ وَالْغَيْب"
permalink: /etudes/eschatologie/
---

<div class="site-main">
  <div class="page-header">
    <div class="page-header__categorie" style="font-family:var(--font-arabe);font-size:1.4rem;color:var(--or3);margin-bottom:.5rem;direction:rtl;">الْآخِرَةُ وَالْغَيْب</div>
    <h1 class="page-header__titre">Eschatologie & Métaphysique</h1>
    <p class="page-header__subtitle">La dernière heure, le barzakh, les signes de l'heure, la shafāʿa — l'au-delà selon le Coran.</p>
  </div>
  ...
  <div class="etudes-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.4rem;margin-top:2rem;">
    {% assign cat_etudes = site.etudes | where: "categorie_slug", "eschatologie" | sort: "order" %}
