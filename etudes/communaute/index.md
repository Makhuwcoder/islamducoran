---
layout: default
title: "Communauté religieuse & Identité"
subtitle: "الْجَمَاعَةُ الدِّينِيَّةُ وَالْهُوِيَّة"
permalink: /etudes/communaute/
---

<div class="site-main">
  <div class="page-header">
    <div class="page-header__categorie" style="font-family:var(--font-arabe);font-size:1.4rem;color:var(--or3);margin-bottom:.5rem;direction:rtl;">الْجَمَاعَةُ الدِّينِيَّةُ وَالْهُوِيَّة</div>
    <h1 class="page-header__titre">Communauté religieuse & Identité</h1>
    <p class="page-header__subtitle">Le shirk, le kufr, la minorité des croyants — l'identité religieuse selon le texte coranique.</p>
  </div>
  ...
  <div class="etudes-grid" style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:1.4rem;margin-top:2rem;">
    {% assign cat_etudes = site.etudes | where: "categorie_slug", "communaute" | sort: "order" %}
